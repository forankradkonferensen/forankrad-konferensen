    ...
    return (
        <div className="relative h-screen overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-10">
                ...
                <h4 className="text-lg md:text-2xl px-6 py-2 md:px-12 lg:px-24 xl:px-48 font-medium">{text}</h4>
                <p className="text-sm md:text-base">{bibleRef}</p>
                {buttonHref && buttonText && (
                    <a className="btn bg-white hover:bg-whiteShade outline-none w-40 text-black" href={buttonHref}>{buttonText}</a>
                )}
            </div>
